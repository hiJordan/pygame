...
def check_events(ai_settings, screen, ship, bullets, stats, play_button, aliens, sb):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(stats, play_button, mouse_x, mouse_y, screen, ship, aliens, bullets, ai_settings, sb)


def check_play_button(stats, play_button, mouse_x, mouse_y, screen, ship, aliens, bullets, ai_settings, sb):
...
def check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets, sb):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom or stats.ships_left == 0:
            ship_hit(ai_settings, stats, screen, ship, aliens, bullets, sb)
            break
